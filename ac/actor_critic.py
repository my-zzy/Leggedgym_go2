...
from ac.common_modules import AutoEncoder, BetaVAE, MixedMlp, RnnBarlowTwinsStateHistoryEncoder, RnnStateHistoryEncoder, StateHistoryEncoder, get_activation, mlp_factory, mlp_layernorm_factory
class Config:
    def __init__(self):
        self.n_obs = 45
        self.block_size = 9
