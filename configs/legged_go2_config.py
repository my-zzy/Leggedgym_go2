...
class LeggedRobotCfg(BaseConfig):
    ...
    class domain_rand:
        ...
        # Motor strength and PD gains randomization
        motor_strength_range = [0.9, 1.1]
        kp_range = [0.8, 1.2]
        kd_range = [0.8, 1.2]
        
        # Action lag simulation
        lag_timesteps = 1
        
        # Gravity direction randomization
        gravity_rand_range = [-0.1, 0.1]
    ...
    class rewards:
        ...
        tracking_sigma = 0.25 # tracking reward sigma parameter
        soft_dof_pos_limit = 1. # percentage of urdf limits (applies to both sides)
