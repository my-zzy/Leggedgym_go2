...
class Onexecute:
    ...
    def __init__(self,
        ...
        actor_critic: ActorCriticmlp = actor_critic_class(self.env.cfg.env.n_proprio,
    ...
    def learn(self, num_learning_iterations, init_at_random_ep_len=False):
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            if it % self.save_interval == 0:
                self.save(os.path.join(self.log_dir, 'THUmodel_{}.pt'.format(it)))
            ep_infos.clear()

        self.current_learning_iteration += num_learning_iterations
        self.save(os.path.join(self.log_dir, 'THUmodel_{}.pt'.format(self.current_learning_iteration)))
